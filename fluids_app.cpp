...
{
	if(impl->dataTrans.size() == 0)
	{
		impl->dataTrans.push_back(dataTrans);
		impl->dataRot.push_back(dataRot);
	}
...
void FluidMechanics::setTabletMatrix(const Matrix4& m, const Vector3_f& trans, const Quaternion& rot)
{
	impl->tabletMatrix = m;
